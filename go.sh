...
sudo /greengrass/v2/bin/greengrass-cli deployment create --recipeDir /home/scott/GreengrassCore/recipes --artifactDir /home/scott/GreengrassCore/artifacts --merge "com.example.count_people=1.0.0"
